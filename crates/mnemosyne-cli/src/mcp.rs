    ...
    match name {
        ...
        "mnemosyne_search" => {
            ...
            let locale = match opt_str(args, "calendar") {
                ...
                Some("reiwa") => locale.with_calendar(mnemosyne_core::temporal::Calendar::Reiwa),
                Some("heisei") => locale.with_calendar(mnemosyne_core::temporal::Calendar::Heisei),
                Some("showa") => locale.with_calendar(mnemosyne_core::temporal::Calendar::Showa),
                Some("taisho") => locale.with_calendar(mnemosyne_core::temporal::Calendar::Taisho),
                Some("meiji") => locale.with_calendar(mnemosyne_core::temporal::Calendar::Meiji),
                _ => locale,
            };
