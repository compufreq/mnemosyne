...
| Service | URL | What |
|---|---|---|
| **Grafana** | http://localhost:3000 | Dashboard **“Mnemosyne — Palace”** (metrics + logs + traces + active alerts). Anonymous viewer is on; admin is `admin`/`admin` unless you set `GRAFANA_ADMIN_PASSWORD`. |
